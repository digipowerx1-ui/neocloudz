    ...
    <PageEffects>
      ...
      <section className="hp-section mid">
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div className="hp-label">INFRASTRUCTURE Tiers</div>
          <h2 className="hp-h2">
          ...
          <div className="ent-features-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))" }}>
      ...
      <section className="hp-section dark border-y border-border">
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", flexWrap: "wrap", gap: "64px", alignItems: "center" }}>
          <div style={{ flex: "1 1 400px" }}>
            <div className="hp-label">RELIABILITY & SCALE</div>
            <h2 className="hp-h2">
            ...
            <ul style={{ display: "flex", flexDirection: "column", gap: "20px", listStyle: "none", padding: 0 }}>
              {[
                ...
                <li key={idx} style={{ display: "flex", alignItems: "flex-start", gap: "16px", color: "var(--text)" }}>
      ...
      <section className="hp-section mid">
        <div style={{ maxWidth: "1200px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div className="ent-features-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))" }}>
      ...
      <section className="hp-section dark">
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div className="hp-label">USE CASES</div>
          <h2 className="hp-h2">
            Built for <strong className="g">Real Workloads</strong>
          </h2>
          <p className="hp-sub" style={{ marginBottom: "56px" }}>
